...
- [x] **Step 4: An exclusive-create primitive**
...
- [x] **Step 7: Reinstall, close the task, commit**
...
- [x] **Step 5: Reinstall, close the task, commit**
...
- [x] **Step 4: Error wording for the guard**
...
- [x] **Step 5: CLI flags and the recur branch**
...
- [x] **Step 2: README, AGENTS.md, original design**
...
- [x] **Step 4: Close the task and the umbrella, commit**
